...
RecyclerView.Adapter<SneakerAdapter.SneakerViewHolder>(){
    ...
    override fun onBindViewHolder(holder: SneakerViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener { view ->
            ...
            val bundle = Bundle()
            bundle.putString("sneakerName", sneaker.name)
            bundle.putString("sneakerDescription", sneaker.description)
            bundle.putString("sneakerImage", sneaker.imageId.toString())
